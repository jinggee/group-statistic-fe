<template>
    <div class="hospital-resource">
        <section-view title="医院等级构成">
            <pie-diagram />
        </section-view>
        <section-view title="在职员工分析">
            <div class="flex m-x-20">
                <!-- <indicator-card shadow
          class="f-b-50p"
          name="从业人员"
          value="33,197人">
          <template #foot>
            <div>同比：<span>+7.3%</span></div>
          </template>
        </indicator-card>
        <indicator-card shadow
          class="f-b-50p"
        ...
        <section-view title="床位"> </section-view>
    </div>
</template>
