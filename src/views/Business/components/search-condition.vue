<template>
    <div>
        <van-dropdown-menu>
            <!--年份-->
            <van-dropdown-item v-model="selectedYear" :options="years" @change="onDropdownChange" />
        </van-dropdown-menu>
...
<script lang="ts">
    ...
    import { DropdownMenu, DropdownItem, DropdownItemOption, Cascader, DatetimePicker } from 'vant'
